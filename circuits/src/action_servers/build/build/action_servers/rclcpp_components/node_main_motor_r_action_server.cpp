...
#define NODE_MAIN_LOGGER_NAME "motor_r_action_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmotor_r_action_srvr.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<action_servers::MotorRActionServer>";
