...
#define NODE_MAIN_LOGGER_NAME "motor_l_action_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmotor_l_action_srvr.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<action_servers::MotorLActionServer>";
