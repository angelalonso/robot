...
#define NODE_MAIN_LOGGER_NAME "led_action_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libled_action_srvr.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<action_servers::LedActionServer>";
